...
SELECT * FROM company.staff;

-- create a new view
-- we don't want anyone except from HR to see people's salaries or dob, so the view would hide the info
...
-- insert (8888,'Mike','Davies','Developer',2323,'Database Administrators') into vw_staff_common 
...
-- Alter the table to add defalut values and insert again
...
-- Again let's try to insert a row into the staff table through vw_staff_common
